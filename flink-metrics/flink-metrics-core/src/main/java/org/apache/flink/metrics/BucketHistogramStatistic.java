...
public class BucketHistogramStatistic extends HistogramStatistics {
	...
	public double getStdDev() {
		throw new UnsupportedOperationException("Since BucketHistogramStatistic doesn't store values," +
	...
	private static Map<Double, Double> getQuantiles(long[] buckets, int[] cnt, int size, double[] quantiles) {
