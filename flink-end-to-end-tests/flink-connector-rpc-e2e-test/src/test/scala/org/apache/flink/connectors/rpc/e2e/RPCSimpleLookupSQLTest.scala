...
class RPCSimpleLookupSQLTest extends StreamingTestBase {
  private val LOG = LoggerFactory.getLogger(classOf[RPCSimpleLookupSQLTest])
  ...
  override def before(): Unit = {
    ...
    server = new TSimpleServer(new TServer.Args(serverTransport)
      ...
      .processor(
        new SimpleDimMiddlewareService.Processor[SimpleDimMiddlewareService.Iface]
        (new SimpleLookupServiceImplTest())))
