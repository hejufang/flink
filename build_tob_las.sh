...
mvn clean package -U -T 1C -DskipTests -Dtob-build -Dspecified-modules -Pinclude-hadoop-tob -Dflink.hadoop.version=2.6.0-cdh5.4.4-cfs-1.1.0 -Dhadoop-uber.version=2.6.0-cdh5.4.4-cfs-1.1.0-cfs-1.1.13 -Psql-jars -Pdocs-and-source | grep -v "Progress"
