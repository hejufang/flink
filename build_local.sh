...
# flink test
mvn clean test -Dflink.forkCount=2 -Dflink.forkCountTestPackage=2 -pl flink-cloud-shuffle,flink-runtime,flink-core,flink-metrics/flink-metrics-core,flink-metrics/flink-metrics-databus,flink-metrics/flink-metrics-dropwizard,flink-metrics/flink-metrics-gcs-log,flink-metrics/flink-metrics-opentsdb,flink-metrics/flink-metrics-prometheus,flink-metrics/flink-metrics-slf4j,flink-metrics/flink-metrics-statsd,flink-metrics/flink-metrics-influxdb,flink-metrics/flink-metrics-jmx,flink-metrics/flink-metrics-graphite,flink-metrics/flink-metrics-datadog,flink-table/flink-sql-parser,flink-table/flink-sql-parser-hive,flink-table/flink-table-api-java,flink-table/flink-table-api-java-bridge,flink-table/flink-table-common,flink-table/flink-table-planner-blink,flink-table/flink-table-runtime-blink,flink-table/flink-table-uber-blink,flink-clients,flink-yarn,flink-kubernetes,flink-state-backends/flink-statebackend-rocksdb,flink-libraries/flink-cep,flink-libraries/flink-state-processing-api,flink-connectors/flink-connector-bytesql,flink-connectors/flink-connector-abase,flink-connectors/flink-connector-jdbc,flink-formats/flink-pb,flink-connectors/flink-connector-rocketmq,flink-connectors/flink-connector-bmq,flink-connectors/flink-connector-rpc,flink-connectors/flink-connector-kafka-0.10
