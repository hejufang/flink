...
mvn clean package -U -T 1C -DskipTests -Dtob-build -Dspecified-modules -Pinclude-hadoop-tob -Dhadoop.version=3.2.1 -Dhadoop-uber.version=3.2.1-cfs-1.3.4 -Psql-jars -Pdocs-and-source
