...
public class StateUtil {
	...
	/** Counter of discarded state handles, simple counter not thread-safe */
	...
	public static long getNumDiscardStates() {
		long currentNumDiscardStates = numDiscardStates.getAndSet(0);
		return currentNumDiscardStates;
	}

	public static long getNumLegacyDiscardStates() {
		long currentNumLegacyDiscardStates = numLegacyDiscardStates.getAndSet(0);
		return currentNumLegacyDiscardStates;
	}
}
