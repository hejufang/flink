...
/**
 * Non-HA implementation for {@link SharedClientHAServices}. The address
 * to web monitor is pre-configured.
 */
public class StandaloneSharedClientHAServices implements SharedClientHAServices {
	...
	public StandaloneSharedClientHAServices(String webMonitorAddress) throws Exception {
		this.webMonitorAddress = webMonitorAddress;
		this.leaderRetrievalService = new StandaloneLeaderRetrievalService(webMonitorAddress, DEFAULT_LEADER_ID);
