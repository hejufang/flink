...
/**
 * TaskManager specification, such as cpu num and memory size.
 */
public class TaskManagerSpec {
	private final int taskManagerCPU;

	private final MemorySize taskManagerMemory;

	public TaskManagerSpec(int taskManagerCPU, MemorySize taskManagerMemory) {
