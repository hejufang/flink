...
public class TimestampTMNumBasedFailureRater extends AbstractFailureRater {
	...
	private final double maximumWorkersFailureRateRatio;
	private final double maximumWorkersFailureRateLowerBound;
	...
	public TimestampTMNumBasedFailureRater(double maximumWorkersFailureRateRatio, Time failureInterval, int numTaskSlots, double maximumWorkersFailureRateLowerBound) {
		super(failureInterval);
		this.maximumWorkersFailureRateRatio = maximumWorkersFailureRateRatio;
		this.numTaskSlots = numTaskSlots;
		this.requiredSlots = new ArrayDeque<>();
		this.maximumWorkersFailureRateLowerBound = maximumWorkersFailureRateLowerBound;
	}
	...
	public boolean exceedsFailureRate(Long currentTimeStamp) {
		...
		double limit = Math.max(maximumWorkersFailureRateRatio * taskManagerNum, maximumWorkersFailureRateLowerBound);
		return getCurrentFailureRate(currentTimeStamp) > limit;
	}
