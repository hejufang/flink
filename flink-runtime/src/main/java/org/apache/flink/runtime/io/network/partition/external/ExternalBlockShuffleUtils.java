	...
	public static ResultPartitionID convertRelativeDirToResultPartitionID(String relativeDir) {
		...
		try {
			return new ResultPartitionID(
						new IntermediateResultPartitionID(Long.valueOf(segments[0]), Long.valueOf(segments[1])),
						new ExecutionAttemptID(Long.valueOf(segments[2]), Long.valueOf(segments[3])));
		} catch (Exception e) {
			return null;
		}
	}
