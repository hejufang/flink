 ...
 */
public class PreviewDataHeaders implements MessageHeaders<EmptyRequestBody, PreviewDataResponse, PreviewDataParameters> {

	private static final String URL = String.format("/taskmanagers/:%s/preview", TaskManagerIdPathParameter.KEY);
