...
public class FsCheckpointStorage extends AbstractFsCheckpointStorage {
	...
	public FsCheckpointStorage(
		...
		metricGroup.gauge(CHECKPOINT_WRITE_FILE_LATENCY_METRIC, metricReference::getAvgWriteLatency);
		metricGroup.gauge(CHECKPOINT_CLOSE_FILE_LATENCY_METRIC, metricReference::getAvgCloseLatency);
	}
	...
	private static class CheckpointWriteFileRate implements Gauge<Double>, View {
