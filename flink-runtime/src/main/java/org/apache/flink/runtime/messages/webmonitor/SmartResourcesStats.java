...
public class SmartResourcesStats implements InfoMessage, ResponseBody {
	...
	/**
	 * Resource adjustment history count.
	 */
	public static class ResourcesCount {
		@JsonProperty long memoryMB;
		@JsonProperty double vcores;
		@JsonProperty double count;

		public ResourcesCount(@JsonProperty long memoryMB, @JsonProperty double vcores, @JsonProperty int count) {
	...
	/**
	 * Resource adjustment history info.
	 */
	public static class ResourcesDate {
		...
		public ResourcesDate(@JsonProperty long memoryMB, @JsonProperty double vcores, @JsonProperty String time) {
			this.memoryMB = memoryMB;
			this.vcores = vcores;
			this.time = time;
		}
	...
	public static class Resources {
		...
		public Resources(@JsonProperty long memoryMB, @JsonProperty double vcores) {
			this.memoryMB = memoryMB;
			this.vcores = vcores;
		}
