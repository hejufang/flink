...
public class WorkerExitCode {
	...
	public static final int TASKMANAGER_RELEASESLOT_NOTFOUND = 203;
	public static final int TASKMANAGER_REGISTRATER_RM_TIMEOUT = 204;
	public static final int TASKMANAGER_UPDATE_STATE_RPC_ERROR = 205;
	public static final int TASKMANAGER_UPDATE_STATE_ERROR = 206;
	public static final int TASKMANAGER_LISTENLEADER_RM_ERROR = 207;
	public static final int TASKMANAGER_LISTENLEADER_JM_ERROR = 208;
	public static final int TASKMANAGER_REGISTRATER_RM_ERROR = 209;
