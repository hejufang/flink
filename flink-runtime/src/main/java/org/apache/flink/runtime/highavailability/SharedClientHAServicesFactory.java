 ...
 */
public interface SharedClientHAServicesFactory extends HighAvailabilityServicesFactory {
	 ...
	 */
	SharedClientHAServices createSharedClientHAServices(Configuration configuration) throws Exception;
}
