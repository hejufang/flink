...
public class ZooKeeperMultipleComponentLeaderElectionHaServices extends AbstractZooKeeperHaServices {
	...
	public ZooKeeperMultipleComponentLeaderElectionHaServices(
		...
		super(client, executor, configuration, blobStoreService);
				...
				try {
					...
					throw new FlinkRuntimeException(
						String.format(
							...
							DefaultMultipleComponentLeaderElectionServiceImpl.class
								.getSimpleName()),
						e);
				}
			}
	...
	protected LeaderRetrievalService createLeaderRetrievalService(String leaderPath) {
		...
		return ZooKeeperUtils.createLeaderRetrievalService(leaderNamespacedCuratorFramework, leaderPath, configuration);
	}
