...
public class NettyShuffleMetricFactory {
	...
	private static final String METRIC_ALLOCATED_MEMORY = "AllocatedMemory";
	...
	private static void internalRegisterShuffleMetrics(
		...
		networkGroup.gauge(METRIC_ALLOCATED_MEMORY_SEGMENT,
			networkBufferPool::getNumberOfAllocatedMemorySegments);
		networkGroup.gauge(METRIC_ALLOCATED_MEMORY,
			networkBufferPool::getAllocatedMemory);
