...
/**
 * Serializer interface for savepoint simple metadata.
 */
public interface SavepointSimpleMetadataSerializer extends Versioned {
	/**
	 ...
	 */
	SavepointSimpleMetadata deserialize(DataInputStream dis, ClassLoader userCodeClassLoader) throws IOException;
}
