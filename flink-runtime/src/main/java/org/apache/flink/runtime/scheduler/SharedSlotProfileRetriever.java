...
interface SharedSlotProfileRetriever {
	...
	interface SharedSlotProfileRetrieverFactory {
		...
		SharedSlotProfileRetriever createFromBulk(Set<ExecutionVertexID> bulk, Function<ExecutionVertexID, Collection<TaskManagerLocation>> bannedLocationsRetriever);
	}
}
