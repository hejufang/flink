 ...
 *
 */
public class RecoverableFailoverStrategy implements FailoverStrategy {

	public RecoverableFailoverStrategy() {}

	@Override
	public Set<ExecutionVertexID> getTasksNeedingRestart(ExecutionVertexID executionVertexId, Throwable cause) {
		Set<ExecutionVertexID> res = new HashSet<>();
		res.add(executionVertexId);
		return res;
	}
	...
	public static class Factory implements FailoverStrategy.Factory {
		...
		public FailoverStrategy create(
			...
			return new RecoverableFailoverStrategy();
		}
	}
}
