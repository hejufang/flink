...
/**
 * Responses from the ResourceManager to a registration attempt by a Dispatcher.
 */
public class DispatcherRegistrationSuccess extends RegistrationResponse.Success {
	...
	public DispatcherRegistrationSuccess(
	...
	public String toString() {
		return "DispatcherRegistrationSuccess{" +
