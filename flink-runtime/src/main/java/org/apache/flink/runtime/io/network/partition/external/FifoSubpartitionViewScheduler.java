 ...
 * {@link ExternalBlockSubpartitionView}s in FIFO order.
 */
public class FifoSubpartitionViewScheduler implements ExternalBlockSubpartitionViewScheduler {

	@VisibleForTesting
	protected final Queue<ExternalBlockSubpartitionView> subpartitionViewQueue;

	public FifoSubpartitionViewScheduler() {
		this.subpartitionViewQueue = new ArrayDeque<>();
	}
