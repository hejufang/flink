...
/**
 * ResourceManager offer TaskManagerOfferSlots to JobMaster directly with taskmanager address.
 */
public class TaskManagerOfferSlots implements Serializable {
	private static final long serialVersionUID = 1L;

	private final String taskManagerRpcAddress;
	private final UnresolvedTaskManagerLocation unresolvedTaskManagerLocation;
	private final Collection<SlotOffer> slotOffers;

	public TaskManagerOfferSlots(
	...
	public void addSlotOffer(SlotOffer slotOffer) {
		slotOffers.add(slotOffer);
	}

	public Collection<SlotOffer> getSlotOffers() {
		return slotOffers;
	}
}
