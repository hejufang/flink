...
public class NettyShuffleServiceFactory implements ShuffleServiceFactory<NettyShuffleDescriptor, ResultPartition, SingleInputGate> {
	...
	public ShuffleMaster createShuffleMaster(Configuration configuration) {
		...
		String transport = configuration.getString(NettyShuffleEnvironmentOptions.NETWORK_BOUNDED_BLOCKING_SUBPARTITION_TYPE);
	...
	static NettyShuffleEnvironment createNettyShuffleEnvironment(
		...
		ConnectionManager connectionManager = nettyConfig != null ?
			new NettyConnectionManager(resultPartitionManager, taskEventPublisher, nettyConfig, config.isCreditBased(), metricGroup) :
