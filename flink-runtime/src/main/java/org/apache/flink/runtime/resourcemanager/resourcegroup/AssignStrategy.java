...
/**
 * The AssignStrategy responsible for assigning task manager instance to specific ResourceGroup.
 */
public interface AssignStrategy {

	Map<ResourceID, UnresolvedTaskManagerTopology> onResourceInfoChanged(
	...
	Map<ResourceID, UnresolvedTaskManagerTopology> onAddTaskManager(
		Map<ResourceID, UnresolvedTaskManagerTopology> taskManagers,
	...
	Map<ResourceID, UnresolvedTaskManagerTopology> onRemoveTaskManager(
		Map<ResourceID, UnresolvedTaskManagerTopology> taskManagers,
		List<ResourceInfo> resourceInfos,
