...
/**
 * {@code SharedClientHAServices} provides shared high availability services those are required
 * on client-side, including {@code LeaderRetrievalService} and {@code LeaderRetriever}.
 */
