...
public class EventSerializer {
	...
	private static final int UNAVAILABLE_CHANNEL_EVENT = 6;
	...
	private static ByteBuffer serializeCheckpointBarrier(CheckpointBarrier barrier) throws IOException {
		...
		} else if (checkpointType == CheckpointType.SYNC_DETACH_SAVEPOINT) {
			typeInt = CHECKPOINT_TYPE_SYNC_DETACH_SAVEPOINT;
		} else {
	...
	private static CheckpointBarrier deserializeCheckpointBarrier(ByteBuffer buffer) throws IOException {
		...
		} else if (checkpointTypeCode == CHECKPOINT_TYPE_SYNC_DETACH_SAVEPOINT) {
			checkpointType = CheckpointType.SYNC_DETACH_SAVEPOINT;
		} else {
