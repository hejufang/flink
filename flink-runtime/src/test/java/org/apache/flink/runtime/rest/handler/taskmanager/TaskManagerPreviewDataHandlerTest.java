...
public class TaskManagerPreviewDataHandlerTest extends TestLogger {
    ...
    public void testGetTaskManagerLogsList() throws Exception {
        ...
        final TestingRestfulGateway testingRestfulGateway =
                new TestingRestfulGateway.Builder()
                        ...
                        .build();
        resourceManagerGateway.setRequestTaskManagerPreviewFunction(
                EXPECTED_TASK_MANAGER_ID -> CompletableFuture.completedFuture(expected));
        PreviewDataResponse actual =
                previewDataHandler.handleRequest(handlerRequest, testingRestfulGateway).get();
    ...
    private static HandlerRequest<EmptyRequestBody> createRequest(ResourceID taskManagerId)
        ...
        queryParameters.put(
                PreviewDataJobIdParameter.KEY,
                Collections.singletonList("43ffdd60cb0c88da888ba55beb1f024d"));
        queryParameters.put(
                PreviewDataJobVertexIdParameter.KEY,
                Collections.singletonList("5c51e52cde5a1c4df827ddb38fbc8da9"));
        return HandlerRequest.create(EmptyRequestBody.getInstance(), new PreviewDataParameters());
    }
}
