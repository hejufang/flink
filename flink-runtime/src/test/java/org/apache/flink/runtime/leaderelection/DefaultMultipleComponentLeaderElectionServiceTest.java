...
/** Tests for the {@link DefaultMultipleComponentLeaderElectionServiceImpl}. */
...
class DefaultMultipleComponentLeaderElectionServiceTest {
	...
	public void isLeaderInformsAllRegisteredLeaderElectionEventHandlers() throws Exception {
		...
		final DefaultMultipleComponentLeaderElectionServiceImpl leaderElectionService =
	...
	createDefaultMultiplexingLeaderElectionService(
		...
		throws Exception {
		return new DefaultMultipleComponentLeaderElectionServiceImpl(
	...
	private void registerLeaderElectionEventHandler(
		DefaultMultipleComponentLeaderElectionServiceImpl leaderElectionService,
