 ...
 */
public class TestingSharedClientHAServices implements SharedClientHAServices {
	...
	private TestingSharedClientHAServices(LeaderRetrievalService clusterRestEndpointLeaderRetriever) {
	...
	public static TestingSharedClientHAServices createSharedClientHAServices() {
		return new TestingSharedClientHAServices(new SettableLeaderRetrievalService());
	}
