...
public class TaskManagerDetailsHandlerTest extends TestLogger {
	...
	private static void initializeMetricStore(MetricStore metricStore) {
		...
		metricStore.add(new MetricDump.CounterDump(tmScope, "Shuffle.Netty.AllocatedMemorySegments", 17));
		metricStore.add(new MetricDump.CounterDump(tmScope, "Shuffle.Netty.TotalMemorySegments", 18));

		metricStore.add(new MetricDump.CounterDump(tmScope, "Shuffle.Netty.AvailableMemory", 19));
		metricStore.add(new MetricDump.CounterDump(tmScope, "Shuffle.Netty.UsedMemory", 20));
		metricStore.add(new MetricDump.CounterDump(tmScope, "Shuffle.Netty.AllocatedMemory", 21));
		metricStore.add(new MetricDump.CounterDump(tmScope, "Shuffle.Netty.TotalMemory", 22));
	}
