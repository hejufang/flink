...
public abstract class AbstractLeaderElectionEvent {
	...
	public static class IsLeaderEvent extends AbstractLeaderElectionEvent {
		@Override
		public boolean isIsLeaderEvent() {
			return true;
		}
	...
	public static class NotLeaderEvent extends AbstractLeaderElectionEvent {
		@Override
		public boolean isNotLeaderEvent() {
			return true;
		}
	...
	public static class LeaderInformationChangeEvent extends AbstractLeaderElectionEvent {
	...
	public static class AllKnownLeaderInformationEvent extends AbstractLeaderElectionEvent {
