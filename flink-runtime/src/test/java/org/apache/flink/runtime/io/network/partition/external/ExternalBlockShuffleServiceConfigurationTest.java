...
/**
 * Test for external block shuffle service configuration.
 */
public class ExternalBlockShuffleServiceConfigurationTest {
	...
	public void testMemoryAllocation() throws Exception {
...

		{
			...
			configuration.setInteger(NettyShuffleEnvironmentOptions.NUM_ARENAS, 14);
...

		{
			...
			configuration.setInteger(ExternalBlockShuffleServiceOptions.MEMORY_SIZE_PER_BUFFER_IN_BYTES, 4096);
			configuration.setInteger(NettyShuffleEnvironmentOptions.NUM_ARENAS, 20);
			...
			assertEquals(20480, externalBlockShuffleServiceConfiguration.getBufferNumber().intValue());
		}

		{
			...
			configuration.setInteger(ExternalBlockShuffleServiceOptions.MEMORY_SIZE_PER_BUFFER_IN_BYTES, 4096);
			configuration.setInteger(NettyShuffleEnvironmentOptions.NUM_ARENAS, 24);
	...
	public void testFromConfiguration() throws Exception {
		...
		configuration.setInteger(NettyShuffleEnvironmentOptions.NUM_ARENAS, 31);
