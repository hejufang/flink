...
public class SlotSharingExecutionSlotAllocatorTest {
	...
	private static class AllocationContext {
		...
		private static class Builder {
			...
			private Time allocationTimeout = null;
			...
			private Builder setAllocationTimeout(Time allocationTimeout) {
	...
	private static class TestingSharedSlotProfileRetrieverFactory implements SharedSlotProfileRetrieverFactory {
		...
		@Override
		public SharedSlotProfileRetriever createFromBulk(Set<ExecutionVertexID> bulk, Function<ExecutionVertexID, Collection<TaskManagerLocation>> bannedLocationsRetriever) {
			askedBulks.add(bulk);
			return group -> {
