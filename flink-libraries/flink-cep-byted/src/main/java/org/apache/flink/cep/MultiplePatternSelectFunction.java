 ...
 * @param <OUT>
 */
public interface MultiplePatternSelectFunction <IN, OUT> extends Function, Serializable {
	 ...
	 */
	OUT select(Tuple2<String, Map<String, List<IN>>> pattern) throws Exception;
}
