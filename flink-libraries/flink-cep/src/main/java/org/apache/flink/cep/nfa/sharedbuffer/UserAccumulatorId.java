...
public class UserAccumulatorId {
	...
	public boolean equals(Object o) {
		...
		return version == that.version && Objects.equals(computationState, that.computationState) && Objects.equals(accmulatorKey, that.accmulatorKey);
	}
	 ...
	 */
	public static class UserAccumulatorIdSerializer extends TypeSerializerSingleton<UserAccumulatorId> {

		public static final UserAccumulatorIdSerializer INSTANCE = new UserAccumulatorIdSerializer();
		...
		@Override
		public void serialize(UserAccumulatorId userAccumulatorId, DataOutputView target) throws IOException {
			target.writeInt(userAccumulatorId.getVersion());
			NFAStateSerializer.INSTANCE.serializeSingleComputationState(userAccumulatorId.getComputationState(), target);
		...
		public UserAccumulatorId deserialize(DataInputView source) throws IOException {
			...
			ComputationState computationState = NFAStateSerializer.INSTANCE.deserializeSingleComputationState(source);
			String accumulatorKey = StringValue.readString(source);
			return new UserAccumulatorId(computationState, accumulatorKey);
		}

		@Override
		public UserAccumulatorId deserialize(UserAccumulatorId reuse, DataInputView source) throws IOException {
		...
		public static class UserAccumulatorIdSerializerSnapshot extends SimpleTypeSerializerSnapshot<UserAccumulatorId> {
