 ...
 * @param <OUT>
 */
public abstract class MultiplePatternProcessFunctionV2<IN, OUT> extends AbstractRichFunction {
	...
	public void processNewPattern(final PatternProcessor patternProcessor) {}
