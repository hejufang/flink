 ...
 * @param <OUT>
 */
public interface MultiplePatternFlatSelectFunction<IN, OUT> extends Function, Serializable {
	 ...
	 */
	void flatSelect(Tuple2<String, Map<String, List<IN>>> pattern, Collector<OUT> out) throws Exception;
}
