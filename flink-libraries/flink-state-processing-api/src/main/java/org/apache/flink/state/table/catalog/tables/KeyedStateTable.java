 ...
 * KeyedStateTable.
 */
public class KeyedStateTable extends SavepointTable{
	...
	public KeyedStateTable(String tableName, String savepointPath, String operatorID, String stateName) {
		super(tableName);
	...
	public TableSchema getTableSchema() {
		return KEYED_STATE_TABLE_SCHEMA;
	}
	...
	public CatalogTableImpl getTable() {
		...
		return new CatalogTableImpl(KEYED_STATE_TABLE_SCHEMA, properties, "");
	}
}
