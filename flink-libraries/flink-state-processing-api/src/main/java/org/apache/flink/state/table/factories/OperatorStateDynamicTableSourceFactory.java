...
import org.apache.flink.state.table.tables.OperatorStateDynamicTableSource;
...
/**
 * Factory for Operator State batch table source.
 */
public class OperatorStateDynamicTableSourceFactory implements DynamicTableSourceFactory {

	private static final String IDENTIFIER = SAVEPOINT_OPERATOR_STATE_TABLE_NAME;
