...
/**
 * Partitioner that distributes the data according to each channel's backlog.
 *
 * @param <T> Type of the elements in the Stream being rebalanced
 */
@Internal
public class BacklogBasedRebalancePartitioner<T> extends StreamPartitioner<T> implements ConfigurableBacklogPartitioner {
