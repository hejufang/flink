 ...
 */
@Public
public abstract class PreviewSinkFunction<IN> extends RichSinkFunction<IN> {
	public abstract PreviewDataResponse getPreviewData(PreviewDataRequest previewDataRequestBody);
}
