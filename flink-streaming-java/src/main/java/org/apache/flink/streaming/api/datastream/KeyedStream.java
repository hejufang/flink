...
public class KeyedStream<T, KEY> extends DataStream<T> {
	...
	public static class IntervalJoin<T1, T2, KEY> {
		...
		IntervalJoin(
			...
			this(streamOne, streamTwo, IntervalJoinType.INTERVAL_INNER_JOIN);
		}
	...
	public static class IntervalJoined<IN1, IN2, KEY> {
		...
		public IntervalJoined(
			...
			this(left, right, lowerBound, upperBound, lowerBoundInclusive, upperBoundInclusive, IntervalJoinType.INTERVAL_INNER_JOIN);
		}
