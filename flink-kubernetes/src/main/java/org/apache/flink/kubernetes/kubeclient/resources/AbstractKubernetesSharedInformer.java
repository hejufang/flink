...
public abstract class AbstractKubernetesSharedInformer<T extends HasMetadata, R>
	...
	public AbstractKubernetesSharedInformer(
	...
	private static final class WatchCallback<T> {
		...
		private WatchCallback(
			WatchCallbackHandler<T> handler, @Nullable Executor executor) {
