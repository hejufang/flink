...
public interface StateRegistry {
	...
	<T> ValueState<T> getState(ValueStateDescriptor stateProperties);
	...
	<T> ListState<T> getOperatorListState(ListStateDescriptor<T> stateProperties);

	<N, S extends State, V> S getOrCreateKeyedState(
		final TypeSerializer<N> namespaceSerializer,
		StateDescriptor<S, V> stateDescriptor) throws Exception;

	<S extends State, N> S getPartitionedState(
			N namespace,
