...
public class SnappyHadoopInputStreamFactory implements InflaterInputStreamFactory<CompressionInputStream> {
	...
	private static SnappyHadoopInputStreamFactory INSTANCE = new SnappyHadoopInputStreamFactory();
	private static CompressionCodec SNAPPY_CODEC;

	static {
		Configuration hadoopConf = new Configuration();
		hadoopConf.set("io.compression.codecs", SnappyCodec.class.getName());
