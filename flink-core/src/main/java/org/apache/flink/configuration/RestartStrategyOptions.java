...
public class RestartStrategyOptions {
	...
	public static final ConfigOption<Integer> RESTART_STRATEGY_AGGREGATED_FAILURE_RATE_MAX_FAILURES_PER_INTERVAL = ConfigOptions
		.key("restart-strategy.aggregated-failure-rate.max-failures-per-interval")
		.defaultValue(1)
		.withDescription(
			Description.builder()
				.text(
	...
	public static final ConfigOption<Duration> RESTART_STRATEGY_AGGREGATED_FAILURE_RATE_FAILURE_RATE_INTERVAL = ConfigOptions
		.key("restart-strategy.aggregated-failure-rate.failure-rate-interval")
		.durationType()
		.defaultValue(Duration.ofMinutes(1))
		.withDescription(
			Description.builder()
	...
	public static final ConfigOption<Duration> RESTART_STRATEGY_AGGREGATED_FAILURE_RATE_DELAY = ConfigOptions
		.key("restart-strategy.aggregated-failure-rate.delay")
		.durationType()
		.defaultValue(Duration.ofSeconds(1))
		.withDescription(
			Description.builder()
