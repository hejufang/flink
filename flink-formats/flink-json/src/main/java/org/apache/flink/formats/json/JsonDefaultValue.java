 ...
 */
public class JsonDefaultValue implements Serializable {

	private static final long serialVersionUID = 1L;

	public DeserializationRuntimeConverter createConverter(LogicalType typeInfo) {
		DeserializationRuntimeConverter baseConverter = createConverterFromTypeInfo(typeInfo)
			.orElseGet(() -> null);
		return baseConverter;
	}

	private Optional<DeserializationRuntimeConverter> createConverterFromTypeInfo(LogicalType type) {
