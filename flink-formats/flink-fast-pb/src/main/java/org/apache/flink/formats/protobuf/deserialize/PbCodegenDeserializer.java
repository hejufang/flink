...
public interface PbCodegenDeserializer {
	 ...
	 *                                  name will be used by outsider codegen environment. {@code
	 *                                  returnInternalDataVarName} should be flink data object
	 * @param pbGetStr                  may be a variable or expression. Current codegen environment
	 *                                  can use this literal name directly to access the input.
	 *                                  {@code pbGetStr} is a value coming from protobuf object
