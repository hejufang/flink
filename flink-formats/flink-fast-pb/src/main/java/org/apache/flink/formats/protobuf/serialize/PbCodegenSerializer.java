...
public interface PbCodegenSerializer {
	...
	/**
	 * @param returnPbVarName    the final var name that is calculated by codegen. This var name
	 *                           will be used by outsider codegen environment. {@code
	 *                           returnPbVarName} should be protobuf object
	 ...
	 *                           internalDataGetStr} is a value coming from flink object.
