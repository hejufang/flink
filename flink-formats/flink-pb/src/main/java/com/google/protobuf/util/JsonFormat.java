...
/**
 * This class was copied from com.google.protobuf:protobuf-java-util.
 * Because we find there is a bug in parseUint64(JsonElement json): when the json is a negative
 * long value, it will throw an Exception, which is not what we expect.
 */
