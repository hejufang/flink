...
/**
 * This class is migrated from io.confluent.kafka.schemaregistry.protobuf.dynamic#DynamicSchema, which
...
public class DynamicSchema {
	...
	private Map<String, EnumDescriptor> mEnumDescriptorMapFull = new HashMap<>();
	private Map<String, EnumDescriptor> mEnumDescriptorMapShort = new HashMap<>();

	/**
	 * Builder for {@link DynamicSchema}.
	 */
