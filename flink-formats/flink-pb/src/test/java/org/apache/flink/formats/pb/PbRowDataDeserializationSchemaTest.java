...
public class PbRowDataDeserializationSchemaTest {
	...
	private static PbRowDataDeserializationSchema getDeserializationSchema(boolean withWrapper) {
		Descriptors.Descriptor descripter = PbUtils.validateAndGetDescriptor(TEST_PB_CLASS_NAME);
		DataType dataType = PbFormatFactory.createDataType(descripter, withWrapper);
