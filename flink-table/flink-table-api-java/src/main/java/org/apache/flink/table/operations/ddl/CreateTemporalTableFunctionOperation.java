...
/**
 * Operation to describe a CREATE TEMPORAL TABLE FUNCTION statement.
 */
public class CreateTemporalTableFunctionOperation implements CreateOperation {

	private final String temporalTableName;
	...
	public String asSummaryString() {
		...
		params.put("temporalTableName", temporalTableName);
		params.put("viewOrTableName", viewOrTableName);
		params.put("timeAttribute", timeAttribute);
