 ...
 */
public abstract class LastValueIgnoreRetractAggFunctionWithoutOrderTest<T> extends AggFunctionTestBase<T, GenericRow> {
	 ...
	 */
	public static class BooleanLastValueIgnoreRetractAggFunctionWithoutOrderTest
			extends LastValueIgnoreRetractAggFunctionWithoutOrderTest<Boolean> {
	 ...
	 */
	public static class DecimalLastValueIgnoreRetractAggFunctionWithoutOrderTest
			extends LastValueIgnoreRetractAggFunctionWithoutOrderTest<Decimal> {
	 ...
	 */
	public static class StringLastValueIgnoreRetractAggFunctionWithoutOrderTest
			extends LastValueIgnoreRetractAggFunctionWithoutOrderTest<BinaryString> {
