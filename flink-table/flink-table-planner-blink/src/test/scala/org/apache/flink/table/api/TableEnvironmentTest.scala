  ...
  def testAnalyzeTableSqlWithAllColumn(): Unit = {
    ...
    val expectedSql =
      """
        ...
        | CAST(NULL AS UNKNOWN),
        | CAST(APPROX_COUNT_DISTINCT(`m`) AS BIGINT),
        ...
        | CAST(APPROX_COUNT_DISTINCT(`n`) AS BIGINT),
