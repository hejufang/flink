...
class CatalogTableITCase(isStreamingMode: Boolean) {
  ...
  def testCreateScalarFunction(): Unit = {
    ...
    val functionDDL =
      """
        |create function fun1 as 'org.apache.flink.table.planner.catalog.ScalarFunctionTest'
      """.stripMargin
    val sourceDDL =
      """
        |create table t1(
  ...
  def testCreateTableFunction(): Unit = {
    ...
    val functionDDL =
      """
        |create function fun1 as 'org.apache.flink.table.planner.catalog.TableFunctionTest'
      """.stripMargin
    val sourceDDL =
      """
        |create table t1(
  ...
  def testCreateTableFunctionColumn(): Unit = {
    ...
    val functionDDL =
      """
        |create function fun1 as 'org.apache.flink.table.planner.catalog.TableFunctionColumnTest'
      """.stripMargin
    val sourceDDL =
      """
        |create table t1(
