...
public abstract class FirstValueIgnoreRetractAggFunction<T> extends FirstValueAggFunction<T> {
	...
	/**
	 * Built-in Object FirstValue aggregate function ignoring retraction.
	 */
	public static class ObjectFirstValueIgnoreRetractAggFunction extends FirstValueIgnoreRetractAggFunction<Object> {
		...
		public ObjectFirstValueIgnoreRetractAggFunction(TypeInformation<?> typeInformation) {
			...
			this.converter = DataStructureConverters
				.getConverter(LegacyTypeInfoDataTypeConverter.toDataType(typeInformation));
		}
