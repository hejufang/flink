 ...
 */
public class LookupJoinWithCalcRetryRunner extends LookupJoinWithRetryRunner {
	...
	public LookupJoinWithCalcRetryRunner(
			...
			long latencyMs) {
		super(generatedFetcher, generatedCollector, baseRowTypeInfo, isLeftOuterJoin, tableFieldsCount, latencyMs);
