...
import org.apache.flink.runtime.util.docker.DockerUtilsTest;
...
public class UtilsTest extends TestLogger {
	...
	public void setDockerEnv() {
		Configuration flinkConf = DockerUtilsTest.getDockerFlinkConf();
		...
		assertTrue(envMap.get(YarnConfigKeys.ENV_YARN_CONTAINER_RUNTIME_DOCKER_IMAGE_KEY).startsWith(DockerUtilsTest.DEFAULT_IMAGE_PREFIX));
