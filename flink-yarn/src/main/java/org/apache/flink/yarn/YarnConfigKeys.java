...
public class YarnConfigKeys {
	...
	public static final String DOCKER_MOUNTS_DEFAULT_ENABLE_KEY = "docker.mount_default.enable";
	public static final boolean DOCKER_MOUNTS_DEFAULT_ENABLE_DEFAULT = true;
