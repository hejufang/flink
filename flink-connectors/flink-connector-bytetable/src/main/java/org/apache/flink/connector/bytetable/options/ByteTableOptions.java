...
public class ByteTableOptions {
	...
	@Override
	public int hashCode() {
		return Objects.hash(database, tableName, psm, cluster, service, rateLimiter);
	}
	...
	public static class Builder {
		...
		public ByteTableOptions build() {
			...
			return new ByteTableOptions(database, tableName, psm, cluster, service, rateLimiter);
		}
	}
}
