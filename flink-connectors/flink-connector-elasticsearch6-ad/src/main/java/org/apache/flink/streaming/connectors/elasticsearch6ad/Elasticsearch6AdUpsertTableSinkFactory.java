...
/**
 * upport ad gdpr es cluster.
 */
public class Elasticsearch6AdUpsertTableSinkFactory extends Elasticsearch6UpsertTableSinkFactory {

	@Override
	protected String elasticsearchVersion() {
		return CONNECTOR_VERSION_VALUE_6_AD;
	}
