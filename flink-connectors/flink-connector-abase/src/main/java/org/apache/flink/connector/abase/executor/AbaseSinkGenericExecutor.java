 ...
 * events and then submit to abase.
 */
public class AbaseSinkGenericExecutor extends AbaseSinkBatchExecutor<RowData> {
	private static final long serialVersionUID = 1L;
	private final transient List<RowData> recordBuffer;
	public AbaseSinkGenericExecutor(ExecuteFunction<RowData> execution) {
		super(execution);
