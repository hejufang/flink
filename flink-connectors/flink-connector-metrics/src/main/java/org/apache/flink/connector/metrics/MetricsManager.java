...
package org.apache.flink.connector.metrics;

import org.apache.flink.connector.metrics.table.MetricsOptions;
...
public class MetricsManager {
	...
	private final SimpleByteTSDMetrics client;
	...
	private MetricsManager(MetricsOptions metricsOptions) {
		...
		int batchSize = metricsOptions.getBufferMaxRows();
		int flushIntervalMs = (int) metricsOptions.getBufferFlushInterval();
