...
public class InnerTestStruct implements org.apache.thrift.TBase<InnerTestStruct, InnerTestStruct._Fields>, java.io.Serializable, Cloneable, Comparable<InnerTestStruct> {
  ...
  private static class InnerTestStructStandardScheme extends StandardScheme<InnerTestStruct> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, InnerTestStruct struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.mapVal = new HashMap<String,Long>(2*_map0.size);
                String _key1;
                long _val2;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.listVal = new ArrayList<Long>(_list4.size);
                long _elem5;
                for (int _i6 = 0; _i6 < _list4.size; ++_i6)
                {
                  _elem5 = iprot.readI64();
                  struct.listVal.add(_elem5);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InnerTestStruct struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.mapVal != null) {
        if (struct.isSetMapVal()) {
          oprot.writeFieldBegin(MAP_VAL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter7 : struct.mapVal.entrySet())
            {
      ...
      if (struct.listVal != null) {
        if (struct.isSetListVal()) {
          oprot.writeFieldBegin(LIST_VAL_FIELD_DESC);
          {
            ...
            for (long _iter8 : struct.listVal)
            {
  ...
  private static class InnerTestStructTupleScheme extends TupleScheme<InnerTestStruct> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, InnerTestStruct struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetMapVal()) {
        {
          ...
          for (Map.Entry<String, Long> _iter9 : struct.mapVal.entrySet())
          {
      ...
      if (struct.isSetListVal()) {
        {
          ...
          for (long _iter10 : struct.listVal)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, InnerTestStruct struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.mapVal = new HashMap<String,Long>(2*_map11.size);
          String _key12;
          long _val13;
          for (int _i14 = 0; _i14 < _map11.size; ++_i14)
          {
            ...
            struct.mapVal.put(_key12, _val13);
          }
        }
        struct.setMapValIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.listVal = new ArrayList<Long>(_list15.size);
          long _elem16;
          for (int _i17 = 0; _i17 < _list15.size; ++_i17)
          {
            _elem16 = iprot.readI64();
            struct.listVal.add(_elem16);
          }
        }
        struct.setListValIsSet(true);
      }
