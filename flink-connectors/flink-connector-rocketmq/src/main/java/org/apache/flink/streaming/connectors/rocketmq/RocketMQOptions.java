...
public class RocketMQOptions {
	...
	public static class RocketMQOptionsBuilder {
		...
		public RocketMQOptions.RocketMQOptionsBuilder setAsync(boolean async) {
			this.async = async;
			return this;
		}

		public RocketMQOptions.RocketMQOptionsBuilder setBatchFlushOnCheckpoint(boolean batchFlushOnCheckpoint) {
			this.batchFlushOnCheckpoint = batchFlushOnCheckpoint;
			return this;
		}

		public RocketMQOptions.RocketMQOptionsBuilder setBatchSize(int batchSize) {
			this.batchSize = batchSize;
			return this;
		}
