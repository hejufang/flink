...
/**
 * DefaultMQConsumerFactory.
 */
public class DefaultMQConsumerFactory implements RocketMQConsumerFactory {
	...
	public DefaultMQPullConsumer createRocketMqConsumer(
		...
		properties.put(ConsumerConfig.INSTANCE_NAME, instanceName);
		return new DefaultMQPullConsumer(cluster, topic, group, properties);
	}
}
