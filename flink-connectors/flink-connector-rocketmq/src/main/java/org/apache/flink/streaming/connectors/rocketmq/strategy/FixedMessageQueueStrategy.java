 ...
 */
public class FixedMessageQueueStrategy implements AllocateMessageQueueStrategy {
	private static final Logger LOG =
		LoggerFactory.getLogger(FixedMessageQueueStrategy.class);
	...
	public List<MessageQueue> allocate(
		...
		LOG.info("Use FixedMessageQueueStrategy, subTaskId {}, assigned queues {}", subTaskId,
			result.stream().map(MessageQueue::toString).collect(Collectors.joining(",")));
