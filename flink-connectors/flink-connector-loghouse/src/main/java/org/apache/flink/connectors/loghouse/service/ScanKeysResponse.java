...
public class ScanKeysResponse implements org.apache.thrift.TBase<ScanKeysResponse, ScanKeysResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ScanKeysResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ScanKeysResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ScanKeysResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ScanKeysResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ScanKeysResponse.class, metaDataMap);
  }
   ...
   */
  public ScanKeysResponse(ScanKeysResponse other) {
  ...
  public ScanKeysResponse deepCopy() {
  ...
  public ScanKeysResponse setStatus(@org.apache.thrift.annotation.Nullable Status status) {
    this.status = status;
    return this;
  }
  ...
  public ScanKeysResponse setKeys(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> keys) {
    this.keys = keys;
    return this;
  }
  ...
  public ScanKeysResponse setBaseResp(@org.apache.thrift.annotation.Nullable org.apache.flink.connectors.loghouse.service.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof ScanKeysResponse)
      return this.equals((ScanKeysResponse)that);
    return false;
  }

  public boolean equals(ScanKeysResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(ScanKeysResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ScanKeysResponse(");
    boolean first = true;
  ...
  private static class ScanKeysResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ScanKeysResponseStandardScheme getScheme() {
      return new ScanKeysResponseStandardScheme();
    }
  }

  private static class ScanKeysResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<ScanKeysResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ScanKeysResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.keys = new java.util.ArrayList<java.lang.String>(_list68.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ScanKeysResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.keys != null) {
        oprot.writeFieldBegin(KEYS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter71 : struct.keys)
          {
  ...
  private static class ScanKeysResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ScanKeysResponseTupleScheme getScheme() {
      return new ScanKeysResponseTupleScheme();
    }
  }

  private static class ScanKeysResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<ScanKeysResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ScanKeysResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeys()) {
        {
          ...
          for (java.lang.String _iter72 : struct.keys)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ScanKeysResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.keys = new java.util.ArrayList<java.lang.String>(_list73.size);
