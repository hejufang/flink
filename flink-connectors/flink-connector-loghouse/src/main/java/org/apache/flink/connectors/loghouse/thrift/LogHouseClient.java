...
public class LogHouseClient {
	...
	private final LogHouseDiscovery discovery;
	...
	private final GenericKeyedObjectPool<LogHouseDiscovery.HostPort, ThriftClientFactory.ThriftClient> clientPool;
	...
	public LogHouseClient(LogHouseOptions options) {
		...
		this.clientPool = new GenericKeyedObjectPool<>(clientFactory, config);
		this.discovery = new LogHouseDiscovery();
	}
