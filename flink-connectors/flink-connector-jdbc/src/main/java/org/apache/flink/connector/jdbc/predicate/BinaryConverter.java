...
/**
 * Converter for general binary operators, such as {@code a + b}.
 */
public class BinaryConverter implements Converter {

	private final String op;

	public BinaryConverter(String op) {
		this.op = op;
	}
	...
	public Predicate apply(Predicate... predicates) {
		...
		final String pred = String.format("(%s %s %s)", p0.getPred(), op, p1.getPred());
		return new Predicate(pred, p0.plus(p1));
	}
}
