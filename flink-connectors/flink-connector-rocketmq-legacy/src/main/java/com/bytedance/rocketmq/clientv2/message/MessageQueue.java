...
package com.bytedance.rocketmq.clientv2.message;

import java.io.Serializable;

/**
 * MessageQueue to support rollback from flink-connector-rocketmq-legacy.
 */
public class MessageQueue implements Comparable<MessageQueue>, Serializable {
	private static final long serialVersionUID = -5024209774086269703L;
