...
/**
 * Helps to specify an Bytable Table's schema.
 */
public class BytableTableSchema implements Serializable {
	...
	public void addColumn(String family, String qualifier, Class<?> clazz) {
		...
		if (!BytableTypeUtils.isSupportedType(clazz)) {
			// throw exception
	...
	/**
	 * Sets the charset for value strings and Bytable identifiers.
	 *
	 * @param charset the charset for value strings and Bytable identifiers.
	 */
	...
	/**
	 * Returns the Bytable identifiers of all registered column families.
	 *
	 * @return The Bytable identifiers of all registered column families.
	 */
	...
	/**
	 * Returns the Bytable identifiers of all registered column qualifiers for a specific column family.
	 *
	 * @param family The name of the column family for which the column qualifier identifiers are returned.
	 * @return The Bytable identifiers of all registered column qualifiers for a specific column family.
	 */
	...
	/**
	 * Returns the charset for value strings and Bytable identifiers.
	 *
	 * @return The charset for value strings and Bytable identifiers.
	 */
	 ...
	 * The row key name is the field name in Bytable schema which can be queried in Flink SQL.
	 */
