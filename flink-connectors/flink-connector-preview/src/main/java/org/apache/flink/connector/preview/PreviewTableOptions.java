...
public class PreviewTableOptions implements Serializable {
	...
	public static class Builder {
		...
		public PreviewTableOptions build() {
			...
			Preconditions.checkArgument(changelogModeEnable ? changelogRowsMax > 0 : true, "changelogRowsMax  must >= 0");
			Preconditions.checkArgument(tableModeEnable ? tableRowsMax > 0 : true, "tableRowsMax must >= 0");
