...
public class RocksDBWriteBatchWrapperTest {
	...
	public void basicTest() throws Exception {
		...
		try (RocksDB db = RocksDB.open(folder.newFolder().getAbsolutePath());
			...
			RocksDBWriteBatchWrapper writeBatchWrapper = new RocksDBWriteBatchWrapper(db, options, 200, RocksDBConfigurableOptions.WRITE_BATCH_SIZE.defaultValue().getBytes())) {
