...
import org.apache.flink.runtime.pyjstorm.PYJStormProgress;
...
/**
 * Pyjstorm spout process.
 */
public class PySpoutProcess implements PYJStormProgress {
	private static final Logger LOG = LoggerFactory.getLogger(PySpoutProcess.class);
	...
	public PySpoutProcess(RuntimeConfig runtimeConfig, String name, int taskId, Spout spout) {
