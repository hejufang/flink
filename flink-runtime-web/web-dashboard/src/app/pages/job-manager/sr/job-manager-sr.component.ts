...
import {Resources, SmartResourceResponse} from "../../../interfaces/smart-resource";
...
export class JobManagerSmartResourceComponent implements OnInit {
  srData: SmartResourceResponse;
